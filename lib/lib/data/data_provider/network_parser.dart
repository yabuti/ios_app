...
class NetworkParser {
    ...
    switch (response.statusCode) {
      ...
      default:
        ...
        throw FetchDataException(
            errorMsg.isNotEmpty && errorMsg != 'Credentials does not match'
                ? errorMsg
  ...
  static Future<void> _clearToken() async {
    try {
      ...
      log('Token cleared due to unauthorized access', name: _className);
    } catch (e) {
      log('Error clearing token: $e', name: _className);
    }
  }
}
