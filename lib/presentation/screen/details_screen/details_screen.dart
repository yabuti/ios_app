...
import 'package:carsbnb/data/data_provider/remote_url.dart';
import 'package:carsbnb/data/model/search_attribute/search_attribute_model.dart';
import 'package:carsbnb/logic/cubit/car_details/car_details_cubit.dart';
import 'package:carsbnb/logic/cubit/car_details/car_details_state.dart';
import 'package:carsbnb/logic/cubit/compare/compare_list_cubit.dart';
import 'package:carsbnb/logic/cubit/compare/compare_list_state.dart';
import 'package:carsbnb/logic/cubit/contact_dealer/contact_dealer_cubit.dart';
import 'package:carsbnb/logic/cubit/contact_dealer/contact_dealer_state.dart';
import 'package:carsbnb/logic/cubit/language_code_state.dart';
import 'package:carsbnb/logic/cubit/review/review_state.dart';
import 'package:carsbnb/utils/language_string.dart';
import 'package:carsbnb/widgets/circle_image.dart';
import 'package:carsbnb/widgets/custom_app_bar.dart';
import 'package:carsbnb/widgets/custom_image.dart';
import 'package:carsbnb/widgets/fetch_error_text.dart';
...
class _DetailsCarScreenState extends State<DetailsCarScreen> {
  ...
  bool checkIfFavorite() {
    // Safely check if the item is in the wishlist
    if (wishList.wishlistModel == null) return false;
  ...
  void toggleFavorite() async {
    if (isFavorite) {
      // Safely find wishlist item
      if (wishList.wishlistModel != null) {
        try {
